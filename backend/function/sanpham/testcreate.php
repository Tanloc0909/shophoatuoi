            ...
            <form method="post" name="frmThemSP" id="frmThemSP">
                ...
                <div class="form-row">
                    <div class="col">
                        <div class="form-group">
                            <label>Giá mới</label>
                            <input type="number" name="sp_gia" id="sp_gia" class="form-control" value="" />
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label>Giá cũ</label>
                            <input type="number" name="sp_giacu" id="sp_giacu" class="form-control" value="" />
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="sp_soluong" id="sp_soluong" class="form-control" value="" />
                        </div>
                    </div>
                ...
                <div class="form-row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <textarea name="sp_mota_ngan" id="sp_mota_ngan" cols="30" rows="3" class="form-control" placeholder="Nhập mô tả sản phẩm"></textarea>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label>Ngày cập nhật</label>
                                <input type="date" name="sp_ngaycapnhat" id="sp_ngaycapnhat" class="form-control" value="" />
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="sp_mota_chitiet" id="sp_mota_chitiet" class="form-control" rows="5"></textarea>
                </div>
