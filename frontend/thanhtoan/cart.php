                            ...
                            <tbody id="datarow">
                                ...
                                <?php foreach ($giohangdata as $sanpham) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" id="sp_soluong_<?= $sanpham['sp_ma'] ?>" name="sp_soluong" value="<?= $sanpham['sp_soluong'] ?>" />
                                        ...
                                        <td><?= number_format($sanpham['sp_soluong'] * $sanpham['gia'], 2, ".", ",")?> vnđ</td>
                                        <td>
